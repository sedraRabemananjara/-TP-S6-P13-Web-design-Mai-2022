        ...
        if (isset($_POST['is_login'])) {
            ...
            if ($result = $mysqli->query($sql)) { 
                ...
                if (!empty($user)) {
                    ?>
                <header>
                    <form id="login-form" class="login-form" name="form1" method="post" action="traitementAcceuil.php">
                        <div class="row"><button type="submit" id="login-button" href="template.php">acceuil</button></div>
                    </form>    
                </header>
                <?php
            ...
            <form id="login-form" class="login-form" name="form1">
                ...
                <div id="form-content">
                    <div class="welcome">
                        ...
                        <br/><br/>
                        <a href="index.php?ac=logout" style="color:white">Logout</a>
                    </div>
                </div>
